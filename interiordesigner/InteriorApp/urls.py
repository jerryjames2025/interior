...
urlpatterns = [
    ...
    path('designer/home/', views.dhome, name='dhome'),
    ...
    path('apply-for-company/<int:designer_id>/', views.apply_for_company, name='apply_for_company'),
    ...
    path('apply-to-company/<int:company_id>/', views.apply_to_company, name='apply_to_company'),
    path('company/change-password/', views.company_change_password, name='company_change_password'),
    path('company/dashboard/', views.company_dashboard, name='company_dashboard'),
    path('company/application/<int:application_id>/<str:action>/', views.handle_application, name='handle_application'),
]
